...
scenario_generator_registry = {
    ...
    "city-inf-5-fog" : (scenario.clear_square_factory, {'size':5, 'min_units':2, 'max_units':4, 'num_cities':1, "fog_of_war":True}),
    ...
    "invasion-fog" : (scenario.invasion_factory, {"n_blue":8, "fog_of_war":True, "city_score":24}),
