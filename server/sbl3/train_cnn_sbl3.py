...
env = gym_interface.GymEnvironment(role="blue", versusAI="pass-agg", versusNeuralNet=None, scenario="city-inf-5", saveReplay=False, actions19=False, ai="gym18", verbose=False, scenarioSeed=4025, scenarioCycle=1)

policy_kwargs = { "features_extractor_class" : MyCNN, "normalize_images" : False }
...
eval_env = env
eval_callback = EvalCallback(eval_env, best_model_save_path="./cnn_sbl3_logs/",
                             log_path="./cnn_sbl3_logs/", eval_freq=10000, n_eval_episodes=3,
